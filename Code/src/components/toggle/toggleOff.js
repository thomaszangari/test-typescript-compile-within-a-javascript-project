...
function ToggleOff(props) {
    return (
        <svg className='toggle-icon'  onClick={props.onToggle} class="bi bi-toggle-off toggle-icon" width={props.size || '16'} height={props.size || '16'} viewBox="0 0 16 16" fill={props.color || 'red'} xmlns="http://www.w3.org/2000/svg">
